...
-(id)init{
    ...
    if (self){
		...
		NSBundle *frameworkBundle = [NSBundle bundleForClass:SharkfoodMuteSwitchDetector.self];
		NSURL *bundleURL = [frameworkBundle.resourceURL URLByAppendingPathComponent:@"react-native-video.bundle"];
		NSBundle *resourceBundle = [NSBundle bundleWithURL:bundleURL];
		
//		NSBundle *reactNativeVideoBundle = [NSBundle bundleWithIdentifier:@"org.cocoapods.react-native-video"];
        NSURL* url = [resourceBundle URLForResource:@"mute" withExtension:@"caf"];
